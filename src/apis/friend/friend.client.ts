...
import { ResponseAPI, ResponseDTO } from '../../common/interfaces/common';
...
const friendApi = {
   ...
   */
  namePatch: async (body: IFriendModifyRequestBody) =>
    await http.patch<ResponseAPI>(`/friend/${body.id}`, { name: body.name }),
