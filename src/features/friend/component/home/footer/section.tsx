...
const FooterSection = forwardRef<HTMLDivElement, IFooterSectionProps>(({ item }: IFooterSectionProps, ref) => {
  return (
    <div ref={ref} className="flex justify-center">
      <button
        className={classNames('flex flex-col p-2 items-center', {
          'text-gray-65 z-[2000] bg-[#fbfbfb] w-[76px]': item === 'Diary',
        })}
      ...
      >
        <Image
          ...
          width={36}
          height={36}
          src={item === 'Diary' ? BOTTOM_TAP[item].iconOn : BOTTOM_TAP[item].iconOff}
          alt=""
        />
